            ...
            <article>
                <div class="row main-color-1">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 profile">
                        <p class="hire">Want to <a href="#">hire</a> me?</p>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 main-color-2">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 how-made additional-left-padding">
                            ...
                            <ul class="plus-bullets">
                                <li>HTML5, CSS3 (using Less), jQuery, preloader (plugin <a href="https://github.com/desandro/imagesloaded" target="_blank">imagesLoaded),</a> animations (plugin <a href="https://github.com/aishek/jquery-animateNumber" target="_blank">animateNumber</a> and <a href="http://gsgd.co.uk/sandbox/jquery/easing/" target="_blank">jQuery Easing),</a></li>
